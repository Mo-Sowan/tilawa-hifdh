...
namespace Tilawa.Api.Data.Migrations
{
    ...
    partial class TilawaDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tilawa.Api.Models.Friendship", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Tilawa.Api.Models.ReciterProfile", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("FrequentlyRecited")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Tilawa.Api.Models.ReciterProfile", b =>
                {
                    b.HasOne("Tilawa.Api.Models.User", null)
                        .WithOne()
                        .HasForeignKey("Tilawa.Api.Models.ReciterProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
